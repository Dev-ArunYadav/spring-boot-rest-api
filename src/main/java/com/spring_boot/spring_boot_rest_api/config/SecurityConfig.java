...
import com.spring_boot.spring_boot_rest_api.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v2/administrator/**").hasRole("ADMIN") // admin role required for admin endpoints
